...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-info">Edit Admin Profile 
      </h6>
    </div>
    <div class="card-body">
      <?php
      ...
      <form action="code.php" method="POST">
        ...
        <a href="adminregister.php" class="btn btn-danger my-3">Cancel</a>
        <button type="submit" name="adminupdate_btn" class="btn btn-info mx-2 my-3">Update</button>
        <?php
            }
          }
